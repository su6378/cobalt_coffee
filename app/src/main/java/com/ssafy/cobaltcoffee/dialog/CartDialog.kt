...
import com.ssafy.cobaltcoffee.databinding.DialogCartBinding

class CartDialog(private val context : AppCompatActivity) {
    ...
    fun show(content : String) {
        binding = DialogCartBinding.inflate(context.layoutInflater)
    ...
    fun setOnOKClickedListener(listener: () -> Unit) {
        this.listener = object: CartDialog.CartDialogOKClickedListener {
