...
class LoginDialog(private val context : AppCompatActivity) {
    private lateinit var binding: DialogLoginBinding
    private val dialog = Dialog(context)

    private lateinit var listener : LoginDialogOKClickedListener

    fun show(content : String) {
        binding = DialogLoginBinding.inflate(context.layoutInflater)
    ...
    fun setOnOKClickedListener(listener: () -> Unit) {
        this.listener = object: LoginDialogOKClickedListener {
    ...
    interface LoginDialogOKClickedListener {
        fun onOKClicked()
    }
}